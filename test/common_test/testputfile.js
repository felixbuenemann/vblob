...
var suite = vows.describe('testputfile: using container '+container_name);
...
suite.addBatch({
  ...
  'PUT container/testputfile-1.txt': {
    topic: api.put_data(container_name+'/testputfile-1.txt','./test/file1.txt',{'content-md5':'9M/h68wG3FYp6CT8mUV6rg='}),
